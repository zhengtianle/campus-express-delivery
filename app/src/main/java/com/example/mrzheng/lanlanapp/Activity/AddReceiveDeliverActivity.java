...
public class AddReceiveDeliverActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private TextInputLayout selectTime;
    private AppCompatButton receiveButtonNext;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        receiveButtonNext.setOnClickListener(this);
    ...
    public void findView(){
        ...
        expressName = (EditText)findViewById(R.id.receive_express_name);
        expressType = (EditText)findViewById(R.id.receive_express_type);
        expressWeight = (EditText)findViewById(R.id.receive_express_weight);
        expressValue = (EditText)findViewById(R.id.receive_express_value);
        money = (EditText)findViewById(R.id.receive_money);
        note = (EditText)findViewById(R.id.receive_note);
        meetingLocation = (EditText)findViewById(R.id.receive_meeting_location);
        meetingTime = (EditText)findViewById(R.id.receive_meeting_time);
        selectTime = (TextInputLayout)findViewById(R.id.receive_select_time);
        receiveButtonNext = (AppCompatButton) findViewById(R.id.button_receive_next);
